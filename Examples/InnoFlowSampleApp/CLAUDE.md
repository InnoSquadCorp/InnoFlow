...
This is a native **iOS application** built with **Swift 6.3+** and **SwiftUI**. The codebase targets **iOS 18.0 and later** while keeping the package portable across Apple platforms. All concurrency is handled with **Swift Concurrency** (async/await, actors, @MainActor isolation) ensuring thread-safe code.
