...
7. Confirm the README installation snippets match the intended public tag.
...
4. [Sources/InnoFlow/InnoFlow.docc/InnoFlow.md](Sources/InnoFlow/InnoFlow.docc/InnoFlow.md)
